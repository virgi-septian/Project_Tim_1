...
<body id="contact">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow" style="background-color: #011b64">
        <div class="container-fluid">
            <img src="../img/logo.png" style="height:70px; width: 100px;" alt="">
    ...
    <section class="jumbotron text-center pb-3">
        <img src="../img/logo.png" alt="eror404" width="200" height="200" class="rounded-circle img-thumbnail" />
        <h1 class="display-4">Tzy Hotel</h1>
        <p class="lead">Hotel | Rekreasi</p>
    </section>
    ...
    <div class="container pt-5">
        ...
        <div class="row text-center justify-content-center fs-5">
            <div class="col-md-4 mb-3">
                <b>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="currentColor"
                        class="bi bi-whatsapp" style="color: rgb(37, 141, 93)" viewBox="0 0 16 16">
                        <path
            ...
            <div class="col-md-4 mb-3">
                <b>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="currentColor"
                        class="bi bi-facebook" style="color: rgb(0, 60, 255)" viewBox="0 0 16 16">
                        <path
            ...
            <div class="col-md-4 mb-3">
                <b>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                        class="bi bi-twitter" style="color: rgb(0, 119, 255)" viewBox="0 0 16 16">
                        <path
